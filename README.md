...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-tmi1cmw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-tmi1cmw.containers.anotherwebservice.com/
...
```
git clone git@github.com:winkokooo12/container-tmi1cmw.git
cd container-tmi1cmw
```
...
```
docker attach container-tmi1cmw
```
